...
const config = {
  ...seoPages["free-coffee-shop-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["coffee-shop"]} />;
  },
};
...
export default function FreeCoffeeShopWebsitePage() {
