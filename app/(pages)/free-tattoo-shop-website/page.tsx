...
const config = {
  ...seoPages["free-tattoo-shop-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["tattoo-shop"]} />;
  },
};
...
export default function FreeTattooShopWebsitePage() {
