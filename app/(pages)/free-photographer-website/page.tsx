...
const config = {
  ...seoPages["free-photographer-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["photographer"]} />;
  },
};
...
export default function FreePhotographerWebsitePage() {
