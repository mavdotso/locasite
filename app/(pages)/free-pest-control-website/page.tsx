...
const config = {
  ...seoPages["free-pest-control-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["pest-control"]} />;
  },
};
...
export default function FreePestControlWebsitePage() {
