...
const config = {
  ...seoPages["free-pressure-washing-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["pressure-washing"]} />;
  },
};
...
export default function FreePressureWashingWebsitePage() {
