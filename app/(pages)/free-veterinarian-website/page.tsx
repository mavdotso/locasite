...
const config = {
  ...seoPages["free-veterinarian-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["veterinarian"]} />;
  },
};
...
export default function FreeVeterinarianWebsitePage() {
