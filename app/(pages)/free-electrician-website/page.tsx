...
const config = {
  ...seoPages["free-electrician-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["electrician"]} />;
  },
};
...
export default function FreeElectricianWebsitePage() {
