...
const config = {
  ...seoPages["free-financial-advisor-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["financial-advisor"]} />;
  },
};
...
export default function FreeFinancialAdvisorWebsitePage() {
