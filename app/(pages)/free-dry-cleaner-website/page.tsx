...
const config = {
  ...seoPages["free-dry-cleaner-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["dry-cleaner"]} />;
  },
};
...
export default function FreeDryCleanerWebsitePage() {
