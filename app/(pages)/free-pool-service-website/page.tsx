...
const config = {
  ...seoPages["free-pool-service-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["pool-service"]} />;
  },
};
...
export default function FreePoolServiceWebsitePage() {
