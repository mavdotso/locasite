...
const config = {
  ...seoPages["free-chiropractor-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["chiropractor"]} />;
  },
};
...
export default function FreeChiropractorWebsitePage() {
