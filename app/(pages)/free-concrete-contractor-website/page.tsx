...
const config = {
  ...seoPages["free-concrete-contractor-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["concrete-contractor"]} />;
  },
};
...
export default function FreeConcreteContractorWebsitePage() {
