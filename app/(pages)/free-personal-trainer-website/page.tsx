...
const config = {
  ...seoPages["free-personal-trainer-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["personal-trainer"]} />;
  },
};
...
export default function FreePersonalTrainerWebsitePage() {
