...
const config = {
  ...seoPages["free-cleaning-service-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["cleaning-service"]} />;
  },
};
...
export default function FreeCleaningServiceWebsitePage() {
