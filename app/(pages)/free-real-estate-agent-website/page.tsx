...
const config = {
  ...seoPages["free-real-estate-agent-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["real-estate-agent"]} />;
  },
};
...
export default function FreeRealEstateAgentWebsitePage() {
