...
const config = {
  ...seoPages["free-yoga-studio-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["yoga-studio"]} />;
  },
};
...
export default function FreeYogaStudioWebsitePage() {
