...
const config = {
  ...seoPages["free-nail-salon-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["nail-salon"]} />;
  },
};
...
export default function FreeNailSalonWebsitePage() {
