...
const config = {
  ...seoPages["free-auto-repair-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["auto-repair"]} />;
  },
};
...
export default function FreeAutoRepairWebsitePage() {
