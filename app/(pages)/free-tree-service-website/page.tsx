...
const config = {
  ...seoPages["free-tree-service-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["tree-service"]} />;
  },
};
...
export default function FreeTreeServiceWebsitePage() {
