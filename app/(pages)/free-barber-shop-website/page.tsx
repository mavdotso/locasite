...
const config = {
  ...seoPages["free-barber-shop-website"],
  previewComponent: function Preview() {
    return <GenericBusinessPreview config={categoryPreviewConfigs["barber-shop"]} />;
  },
};
...
export default function FreeBarberShopWebsitePage() {
