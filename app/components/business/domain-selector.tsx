...
export function DomainSelector({
  ...
  const canUseCustomDomain = canUseFeature("BUSINESS");
            ...
            <Tabs defaultValue="subdomain" className="w-full">
              ...
              <TabsContent value="subdomain" className="space-y-4">
                ...
                <Button
                  ...
                  disabled={
                    isLoading || subdomainInput === currentDomain?.subdomain
                  }
                  className="w-full"
                >
                  ...
                  <div className="text-center py-8 space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground max-w-sm mx-auto">
                        Connect your own domain name to remove Locasite branding
                  ...
                  <>
                    ...
                    <div className="rounded-lg border bg-muted/50 p-4 space-y-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="space-y-1 text-sm">
                          ...
                          <p className="text-muted-foreground">
                            Add the following CNAME record to your domain&apos;s
                            DNS settings:
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-background rounded p-3 font-mono text-xs space-y-1">
                        ...
                        <div>
                          Value: {currentDomain?.subdomain || "your-subdomain"}.
                          {rootDomain}
                        </div>
                      </div>
