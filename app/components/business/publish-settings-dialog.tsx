...
export function PublishSettingsDialog({
	...
	const handlePublish = async () => {
		...
		try {
			if (!domain?.subdomain) {
				toast.error("Domain is not ready yet. Please try again in a moment.");
						...
						<div>
							...
							<Textarea
								...
								placeholder={
									...
									"Describe your business for social media shares"
								}
								className="mt-1"
								rows={3}
							/>
							...
							<div className="mt-1 space-y-2">
								{formData.ogImage ? (
									...
									<MediaLibrary
										...
										trigger={
											<div className="h-32 border-2 border-dashed rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-primary/50 transition-colors">
							...
							<div className="flex gap-2">
								...
								{isLastStep ? (
									<Button
										...
										disabled={
											isPublishing || !formData.pageTitle || !domain?.subdomain
										}
									>
										{isPublishing ? (
											<>
									...
									<Button
										...
										disabled={
											isPublishing ||
											(currentStep === "general" && !formData.pageTitle)
										}
									>
										Next
									</Button>
