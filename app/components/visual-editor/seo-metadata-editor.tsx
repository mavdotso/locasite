...
import { Globe, Share2, AlertCircle, Info } from "lucide-react";
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent className="w-full sm:max-w-2xl overflow-y-auto p-6">
        <SheetHeader>
          <SheetTitle>SEO & Metadata Settings</SheetTitle>
          <SheetDescription>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setLocalMetadata({ ...localMetadata, ogType: value })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="business.business">
                            Business
                          </SelectItem>
                          <SelectItem value="restaurant.restaurant">
                            Restaurant
                          </SelectItem>
                        </SelectContent>
                      </Select>
              ...
              <TabsContent value="advanced" className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setLocalMetadata({ ...localMetadata, robots: value })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
