...
interface LayoutControlsV3Props {
...
function SizeControl({ label, sublabel, value = "", onChange, placeholder = "Auto" }: SizeControlProps) {
  ...
  return (
    <div className="flex-1 relative">
      ...
      >
        <span className="font-normal text-muted-foreground">{isAuto || isNone ? placeholder : numericValue || "0"}</span>
...
export default function LayoutControlsV3({ 
  layout, 
  onChange,
  showTypography = false 
}: LayoutControlsV3Props) {
  ...
  const handlePaddingChange = (side: "top" | "right" | "bottom" | "left", value: string) => {
    ...
    handleChange("padding", `${newPadding.top}px ${newPadding.right}px ${newPadding.bottom}px ${newPadding.left}px`);
  };
  ...
  const handleMarginChange = (side: "top" | "right" | "bottom" | "left", value: string) => {
    ...
    handleChange("margin", `${newMargin.top}px ${newMargin.right}px ${newMargin.bottom}px ${newMargin.left}px`);
  };
  ...
  return (
    <div className="h-full overflow-y-auto overflow-x-hidden">
      ...
      <div className="p-4 border-b border-border/50 space-y-6">
        {/* Padding Visual Box */}
        <div>
          <Label className="text-xs font-medium text-muted-foreground mb-3 block">Padding</Label>
        ...
        {/* Margin Visual Box */}
        <div>
          <Label className="text-xs font-medium text-muted-foreground mb-3 block">Margin</Label>
          <div className="relative">
      ...
      <Section title="Size">
        ...
        <div className="mt-4">
          <Label className="text-xs font-normal text-muted-foreground mb-2 block">Overflow</Label>
          <Select
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button
              ...
              onClick={() => {
                ...
                handleChange("lineHeight", current === "auto" ? "1.5" : "auto");
              }}
            >
              <span className="font-normal">{layout.lineHeight === "auto" ? "Auto" : layout.lineHeight || "Auto"}</span>
            ...
            <div className="flex items-center bg-muted/50 rounded-md px-3 h-10">
              <Input
                ...
                placeholder="0"
              />
              <span className="text-sm text-muted-foreground ml-2">Spacing</span>
            </div>
          </div>
        </Section>
      )}
      ...
      <Section title="Backgrounds">
        <div className="space-y-3">
          <div>
            <Label className="text-xs font-normal text-muted-foreground mb-2 block">Color</Label>
            <div className="flex items-center gap-2">
              <div 
          ...
          <div>
            <Label className="text-xs font-normal text-muted-foreground mb-2 block">Clipping</Label>
            <Select
              value={layout.backgroundClip || "None"}
              onValueChange={(value) => handleChange("backgroundClip", value === "None" ? undefined : value)}
            >
              <SelectTrigger className="h-9">
                <SelectValue />
              </SelectTrigger>
      ...
      <Section title="Borders">
        ...
        {/* Border Style */}
        <div className="mt-4">
          <Label className="text-xs font-normal text-muted-foreground mb-2 block">Border Style</Label>
          <div className="flex items-center gap-2">
