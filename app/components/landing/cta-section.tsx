      ...
      <div className="container relative mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of successful businesses already using Locasite. Get
            your professional website up and running in just 60 seconds.
          </p>
          ...
          <form onSubmit={handleSubmit} className="max-w-xl mx-auto mb-8">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                type="submit"
                size="lg"
                className="h-14 whitespace-nowrap px-8 group bg-background text-blue-600 hover:bg-blue-50 border-0 shadow-lg font-semibold"
              >
                Create My Website
