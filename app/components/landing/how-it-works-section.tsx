      ...
      <div className="container mx-auto px-4 relative">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">
            Create a Website in 
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"> 3 Simple Steps</span>
          </h2>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {steps.map((step, index) => (
              <div key={step.number} className="relative">
                ...
                {/* Step Card */}
                <div className="relative bg-white rounded-2xl shadow-lg border border-blue-100 p-8 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  {/* Step Number */}
        ...
        <div className="mx-auto mt-24 max-w-5xl">
          <div className="rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 p-8 shadow-lg">
            <h3 className="mb-6 text-center text-xl font-bold text-foreground">Try It With These Examples</h3>
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-xl border border-blue-200 bg-card p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-muted-foreground">Starbucks, Blue Bottle Coffee</p>
              </div>
              <div className="rounded-xl border border-blue-200 bg-card p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-sm text-muted-foreground">Local pizzeria, sushi bar</p>
              </div>
              <div className="rounded-xl border border-blue-200 bg-card p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-3 h-3 bg-sky-500 rounded-full"></div>
                  <p className="font-semibold text-foreground">Service Business</p>
                </div>
                <p className="text-sm text-muted-foreground">Plumber, electrician, salon</p>
              </div>
            </div>
          </div>
        </div>
