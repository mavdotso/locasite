                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-muted rounded-lg space-y-3">
                    <p className="text-sm text-muted-foreground">
                      Access advanced SEO settings including custom favicon,
                    ...
                    {businessId && (
                      <div className="space-y-2">
                        ...
                        <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                          <li>Custom favicon for your subdomain</li>
                          <li>Enhanced SEO keywords management</li>
                          <li>Social media preview customization</li>
                          <li>Structured data for better search visibility</li>
                        </ul>

                        <div className="pt-2">
                          <a
                            href={`/dashboard/business/${businessId}?tab=seo`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline"
                          >
                            Open Advanced SEO Settings
                            <svg
                              className="h-4 w-4"
                              fill="none"
                              stroke="currentColor"
                    ...
                    {!businessId && (
                      <p className="text-sm text-muted-foreground italic">
                        Save your page first to access advanced SEO settings.
                      </p>
                    )}
                  </div>
                </div>
