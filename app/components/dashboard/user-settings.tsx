...
export default function UserSettings() {
  ...
  const handleDeleteAccount = () => {
    if (window.confirm('Are you sure you want to delete your account? This action cannot be undone and will delete all your sites and data.')) {
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e) => setNotificationSettings({...notificationSettings, siteUpdates: e.target.checked})}
                  className="h-4 w-4"
                />
              </div>
