    ...
    try {
      ...
      await ctx.runMutation(internal.stripe.storeSubscriptionData, {
        ...
        subscriptionData: {
          ...
          currentPeriodStart: (subscription as unknown as Record<string, unknown>).current_period_start as number | undefined,
          currentPeriodEnd: (subscription as unknown as Record<string, unknown>).current_period_end as number | undefined,
